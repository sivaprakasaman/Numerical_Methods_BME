...
mre_rand_reg_c = regress(Fib4MRE_cost_r',horzcat(senM_lhs,speM_r,ones(400,1)));
mre_lhs_reg_c = regress(Fib4MRE_cost_lhs',horzcat(senM_lhs,speM_lhs,ones(400,1)));

mre_rand_reg_a = regress(Fib4MRE_acc_r',horzcat(senM_lhs,speM_r,ones(400,1)));
mre_lhs_reg_a = regress(Fib4MRE_acc_lhs',horzcat(senM_lhs,speM_lhs,ones(400,1)));
